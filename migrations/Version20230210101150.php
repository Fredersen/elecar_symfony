 ...
 */
final class Version20230210101150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ADD brand_id INT DEFAULT NULL, DROP brand');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ADD brand VARCHAR(255) DEFAULT NULL, DROP brand_id');
    }
}
